...
export const exerciseRegistry: ExerciseDefinition[] = [
  // ===================== ПОСЛУШАНИЕ =====================
  {
    ...
    penaltyTable: [
      ...
      { id: 'leave', description: 'Уходит / не следует', points: 6 },
    ],
  },
  {
    id: 'absence',
    ...
    penaltyTable: [
      ...
      { id: 'posChangeDuring', description: 'Смена положения во время отсутствия', points: 10 },
      { id: 'peekFromHide', description: 'Проводник показался из укрытия', points: 10 },
      { id: 'unauthorizedCmd', description: 'Неразрешённая команда', points: 10 },
      { id: 'lookBack', description: 'Проводник оборачивается / смотрит на собаку', points: 10 },
    ],
  },
  {
    id: 'sendAway',
    ...
    penaltyTable: [
      ...
      { id: 'noFinish', description: 'Не пересекает финишной линии', points: 12 },
  ...
  },
  {
    ...
    penaltyTable: [
      { id: 'extraCmd', description: 'Доп. или неверная команда', points: 12 },
      { id: 'voiceAndGesture', description: 'Команда голосом и жестом', points: 2 },
      { id: 'timeout', description: 'Не уложился в 15 сек', points: 12 },
  ...
  },
  {
    ...
    penaltyTable: [
      { id: 'voiceAndGesture', description: 'Команда голосом и жестом', points: 2 },
      { id: 'extraSendCmd', description: 'Доп. команда посыла', points: 15 },
      { id: 'timeout', description: 'Не принесён / с опозданием', points: 15 },
      { id: 'earlyStartBefore', description: 'Преждевременный старт до сигнала', points: 4 },
      { id: 'earlyStartAfter', description: 'Преждевременный старт после сигнала', points: 2 },
      { id: 'chewing', description: 'Жуёт предмет', points: 1 },
      { id: 'drop', description: 'Роняет предмет, за раз', points: 1, perUnit: true, unitLabel: 'раз' },
      { id: 'notSitting', description: 'Передаёт не из положения сидя', points: 1 },
      { id: 'leaveArea', description: 'Покидает круг 2 м до возвращения', points: 15 },
      { id: 'crawlInArea', description: 'Перемещение в круге 2 м, за метр', points: 1, perUnit: true, unitLabel: 'м' },
      { id: 'wrongItem', description: 'Ошибка с выбором предмета', points: 15 },
    ],
  },
  ...
  },
  {
    ...
    penaltyTable: [
      ...
      { id: 'bites', description: 'Собака делает хватки', points: 30 },
      ...
      { id: 'outsideCircle', description: 'Возвращается за пределы 5 м круга', points: 20 },
    ],
  },
  {
    id: 'searchEscort',
    ...
    penaltyTable: [
      ...
      { id: 'noSearch', description: 'Не отправляется на поиск', points: 40 },
      { id: 'notFound', description: 'Не находит ЧА в установленное время', points: 40 },
      ...
      { id: 'handlerBlocks', description: 'Проводник мешает бежать', points: 30 },
  ...
  },
  {
    ...
    penaltyTable: [
      ...
      { id: 'earlyBiteMeeting', description: 'Кусает до/во время встречи', points: 30 },
      ...
      { id: 'leaves10m', description: 'Уходит на >10 м', points: 30 },
      { id: 'attacksBystander', description: 'Нападает на постороннего', points: 30 },
      { id: 'noProtection', description: 'Не защищает в течение 2 сек', points: 30 },
      { id: 'handlerEncourages', description: 'Проводник подбадривает / менее 3 м', points: 30 },
  ...
  },
  {
    ...
    penaltyTable: [
      ...
      { id: 'draggedBeyond5mNoRelease', description: 'За 5 м и не отпускает 10 сек', points: 30 },
      ...
      { id: 'stolenBeyond10', description: 'Овладел, унёс далее 10 м', points: 30 },
      { id: 'bite2to5m', description: 'Кусает ЧА в зоне 2–5 м', points: 5 },
      { id: 'biteBeyond5m', description: 'Кусает за пределами 5 м', points: 30 },
    ],
  },
]
...
function biteAttackPenalties() {
  return [
    ...
    { id: 'earlyStartRepeat', description: 'Повторный преждевр. старт до сигнала', points: 50 },
    { id: 'earlyStartAfter', description: 'Преждевр. старт после сигнала', points: 5 },
    { id: 'extraSendCmd', description: 'Доп. команда посыла', points: 10 },
    { id: 'unauthorizedActions', description: 'Нерегламентированные действия', points: 50 },
    ...
    { id: 'refusesAttack', description: 'Отказ атаковать / нет хватки', points: 50 },
    { id: 'handlerLeaves', description: 'Проводник покидает стартовую зону', points: 50 },
    { id: 'training', description: 'Использует атаку для тренировки', points: 50 },
